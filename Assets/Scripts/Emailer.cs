...
public class Emailer : MonoBehaviour
{
    ...
    const string kSenderEmailAddress = "zenlandapp@gmail.com";
    const string kSenderPassword = "Chakras007";
    const string kReceiverEmailAddress = "zenlandapp@gmail.com";
    ...
    public static void SendAnEmail(string message)
    {
        ...
        mail.Subject = "Survey - How can we grow Zenland?";
        mail.Body = message;
