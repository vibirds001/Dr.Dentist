...
public class SaveUnlockedPlaylist : MonoBehaviour
{
    ...
    void Start()
    {
        UnlockedPlaylistNumber = PlayerPrefs.GetInt("UnlockedPlaylist", 1);
    }
    ...
    public void Playlist2Unlocked()
    {
        ...
        PlayerPrefs.SetInt("UnlockedPlaylist", UnlockedPlaylistNumber);
        PlayerPrefs.Save();
    }
