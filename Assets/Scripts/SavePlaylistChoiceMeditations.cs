...
public class SavePlaylistChoiceMeditations : MonoBehaviour
{
    ...
    void Start()
    {
        PlaylistNumber = PlayerPrefs.GetInt("PlaylistMeditations", 1);
    ...
    {
        PlaylistNumber = 1;
        PlayerPrefs.SetInt("PlaylistMeditations", PlaylistNumber);
        PlayerPrefs.Save();
    }
