...
public class SaveUnlockedPlaylistMeditations : MonoBehaviour
{
    ...
    void Start()
    {
        UnlockedPlaylistNumber = PlayerPrefs.GetInt("UnlockedPlaylistMeditations", 1);
    }
    ...
    public void Playlist2Unlocked()
    {
        ...
        PlayerPrefs.SetInt("UnlockedPlaylistMeditations", UnlockedPlaylistNumber);
        PlayerPrefs.Save();
    }
